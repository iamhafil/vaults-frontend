          ...
          <div className="row">
            <div className="col-md-4 col col-12">
              <div className="rfq-value">
                ...
                <div className="content-wrapper">
                  <div className="title">{t("rfqS")}</div>
            ...
            <div className="col-md-8 col col-12">
              <div className="rfq-status">
                <div className="title">{t("rfqStatus")}</div>
                <div className="rfq-progress-bar">
                  <div className="progress-wrapper">
                    <div
                      className="inner-wrapper approved"
                      style={{ width: "40%" }}
                    >
                      <span className="rfq-progress"></span>
                      <div className="progress-title">{t("approved")}</div>
                      <div className="tool-tip">
                        <div className="count">
                          {counterWidgetData.approved.count}
                        </div>
                    ...
                    <div
                      className="inner-wrapper pending"
                      style={{ width: "30%" }}
                    >
                      <span className="rfq-progress"></span>
                      <div className="progress-title">{t("pending")}</div>
                      <div className="tool-tip">
                        <div className="count">
                          {counterWidgetData.pending.count}
                        </div>
                        <div className="tool-tip-title">{t("pendingRfqs")}</div>
                      </div>
                    </div>
                    <div
                      className="inner-wrapper cancelled"
                      style={{ width: "16%" }}
                    >
                      <span className="rfq-progress"></span>
                      <div className="progress-title">{t("cancelled")}</div>
                      <div className="tool-tip">
                        <div className="count">
                          {counterWidgetData.cancelled.count}
                        </div>
                        <div className="tool-tip-title">
                          {t("cancelledRfqs")}
                        </div>
                    ...
                    <div
                      className="inner-wrapper rejected"
                      style={{ width: "14%" }}
                    >
                      <span className="rfq-progress"></span>
                      <div className="progress-title">{t("rejected")}</div>
                      <div className="tool-tip">
                        <div className="count">
                          {counterWidgetData.rejected.count}
                        </div>
                        <div className="tool-tip-title">
                          {t("rejectedRfqs")}
                        </div>
                ...
                <div className="rfq-status-values">
                  <div class="inner-wrapper">
                    <div className="percentage">
                      {counterWidgetData.approved.percentage}%
                    </div>
                    <div className="status">{t("approved")}</div>
                  </div>
                  <div class="inner-wrapper">
                    <div className="percentage">
                      {counterWidgetData.pending.percentage}%
                    </div>
                    <div className="status">{t("pending")}</div>
                  </div>
                  <div class="inner-wrapper">
                    <div className="percentage">
                      {counterWidgetData.cancelled.percentage}%
                    </div>
                    <div className="status">{t("cancelled")}</div>
                  </div>
                  <div class="inner-wrapper">
                    <div className="percentage">
                      {counterWidgetData.rejected.percentage}%
                    </div>
                    <div className="status">{t("rejected")}</div>
                  </div>
                </div>
              </div>
            </div>
                        ...
                        <tr>
                          <td className="product-name">
                            <span
                              ...
                              style={{
                                backgroundImage: "url(" + rfq.image + ")",
                              }}
                            ></span>
                            <span className="title">{rfq.name}</span>
                          </td>
                          <td className="sku">
                            <span className="title">ID{rfq.rfqNo}</span>
                          </td>
                          <td className="sku">
                          ...
                          <td className="sample">
                            <span className="title">
                              {camelSentence(rfq.status)}
                            </span>
                          </td>

                          <td className="promotion no">
                            <div class="button-wrapper">
                              <Link href={`/rfqs/${rfq.key}`}>
                                <a className="view">{t("view")}</a>
                              </Link>
...
const Breadcrumb = ({}) => {
  ...
  return (
    <>
      <h1 className="user-message">{t("rfqS")}</h1>
      <div className="sub-title">{t("rfqSubTitle")}</div>
    </>
  );
};
