...
const MenuItem = ({ subMenu, menuClassName, title, subtitle, href, index, children }) => {
    const router = useRouter();
    const [open, setOpen] = useState(false);
    const [aClassName, setAClassName] = useState(subMenu ? "has-sub-menu side-menu-anchor" : "side-menu-anchor")
    ...
    const handleRouteChange = (url) => {
        ...
        if (selectedKeys == index) {
            ...
            setActiveClass("")
            if (open == true) {
                setAClassName(subMenu ? "has-sub-menu side-menu-anchor" : "side-menu-anchor")
                setOpen(false);
            }
        }
    ...
    const handleOnClick = (theKey) => {
        ...
        if (!open) {
            setAClassName(subMenu ? "has-sub-menu side-menu-anchor open" : "side-menu-anchor")
        } else {
            setAClassName(subMenu ? "has-sub-menu side-menu-anchor" : "side-menu-anchor")
        }
    ...
    return (
        <li ref={referance} className={menuClassName + activeClass} >
            <a className={aClassName} onClick={(e) => { handleOnClick(index); }}>
...
const SubMenuItem = ({ title, link }) => {
    ...
    return (
        <li ref={submenu} onClick={(e) => handleOnClick(link)} className={activeClass}><a className={activeClass}>{title}</a></li>
    );
}
const MobileMenu = ({ }) => {
    ...
    return (
        <div>
            <aside className={"connex-side-menu for-mobile d-md-none" + (sliderOpen ? " slide-left" : "")}>
            ...
            <div className="footer-menu for-mobile d-md-none">
                <ul className="footer-menu-list">
                    <li>
                        <Link href="/" className="footer-menu-anchor">
                    ...
                    <li>
                        <Link href="/orders" className="footer-menu-anchor">
                    ...
                    <li>
                        <Link href="/rfqs" className="footer-menu-anchor">
                    ...
                    <li>
                        <Link href="/inbox" className="footer-menu-anchor">
