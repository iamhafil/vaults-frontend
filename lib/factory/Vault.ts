...
export interface VaultInterface extends utils.Interface {
  ...
  events: {
    ...
    "LockedProfitDegradationUpdated(uint256)": EventFragment;
  ...
  getEvent(
    nameOrSignatureOrTopic: "LockedProfitDegradationUpdated"
  ): EventFragment;
...
export interface LockedProfitDegradationUpdatedEventObject {
  value: BigNumber;
}
export type LockedProfitDegradationUpdatedEvent = TypedEvent<
  [BigNumber],
  LockedProfitDegradationUpdatedEventObject
>;

export type LockedProfitDegradationUpdatedEventFilter =
  TypedEventFilter<LockedProfitDegradationUpdatedEvent>;
...
export interface Vault extends BaseContract {
  ...
  filters: {
    ...
    "LockedProfitDegradationUpdated(uint256)"(
      value?: null
    ): LockedProfitDegradationUpdatedEventFilter;
